...
--
-- Name: archive_test; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE archive_test WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';

ALTER DATABASE archive_test OWNER TO postgres;

\connect archive_test
