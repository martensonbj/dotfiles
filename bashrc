...
alias ...="cd ../../"
alias add="git add ."
alias app="cd ~/Projects/highwing/glennis/packages/webapp"
alias commit="git commit -m"
alias cp="cp -i"
alias gac="git add . && git commit -m"
alias glennis="cd ~/Projects/highwing/glennis"
alias la="ls -lA"
alias ll="ls -l"
alias ls="ls -G"
...
alias platform="cd ~/Projects/vangst/platform"
alias pull="git pull origin master"
alias push="git push origin"
alias reload="source ~/.bash_profile && cd ../ && cd -"
alias sb="cd ~/Projects/highwing/glennis/packages/storybook && yarn start"
